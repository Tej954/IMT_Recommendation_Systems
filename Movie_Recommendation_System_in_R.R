...
setwd("C:/Dev/aiproff_myaipoc/IMT/Recommendation Systems & Topic Modeling using R/Recommendation System/IMDB-Dataset")
...
# Just an Overview of some important parameters for building recommendation systems for movies
recommendation_model <- recommenderRegistry$get_entries(dataType = "realRatingMatrix")
names(recommendation_model)

lapply(recommendation_model, "[[", "description")

# Implementing a single model in this R code  – Item Based Collaborative Filtering
recommendation_model$IBCF_realRatingMatrix$parameters

# Collaborative Filtering involves suggesting movies to the users that are based on 
#collecting preferences from many other users.
...
# The number below will be a value which indicates how many movies/users 
#were/did rate at 98 percentile value  
...
# The number below will be a value which indicates how many movies/users 
#were/did rate at 95 percentile value  
...
#plot a grid where the movies which more than 95 percentile users have rated and users 
#who have rated atleast 95 percentile movies are identified
...
#parameter help in guiding the algorithm how many neigbours it has to consider 
...
user1
#the above step should show the user ids 

movies_user1 <- predicted_recommendations@itemLabels[user1]
movies_user1
#These are movieIds, Now we need to pull actual movie names from here 
...
#fetch top 4 most recommended movie
for(i in 1:4) {
